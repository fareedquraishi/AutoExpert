...
class SummaryViewModel @Inject constructor(
    ...
    fun buildReportText(state: SummaryUiState): String {
        ...
        val litresArrow = if (litresDiff >= 0) "▲%.1fL".format(litresDiff) else "▼%.1fL".format(-litresDiff)
...
import os
dst_dir = "app/src/main/java/com/autoexpert/app/ui/summary"
os.makedirs(dst_dir, exist_ok=True)
dst = f"{dst_dir}/SummaryScreen.kt"
