    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new NewCustomerViewModel(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.sessionManagerProvider.get(), singletonCImpl.saleEntryQueueDao(), singletonCImpl.skuDao(), singletonCImpl.vehicleTypeDao(), singletonCImpl.competitorBrandDao(), singletonCImpl.provideSupabaseApiProvider.get(), singletonCImpl.provideGsonProvider.get());
